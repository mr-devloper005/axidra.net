...
export function EmptyState({
  title = 'Nothing published on Axidra yet',
  description = 'Fresh Axidra posts will appear here automatically once this section has published content.',
...
export function TaskEmptyState({ taskLabel = 'posts', className }: { taskLabel?: string; className?: string }) {
  return (
    <EmptyState
      ...
      description={`Published Axidra ${taskLabel} from the master panel will appear here automatically. The page layout stays ready even when the feed is empty.`}
...
export function ContactSuccessState({ className }: { className?: string }) {
  return (
    <EmptyState
      ...
      description="Thanks for reaching out. Your Axidra request has been saved and routed through the contact workflow."
