...
import axidraLogo from '@/editable/assets/axidra-logo.png'

export function EditableFooter() {
  const footerVars = { '--editable-footer-bg': 'var(--editable-page-bg, #ffffff)', '--editable-footer-text': 'var(--editable-page-text, #20252d)' } as CSSProperties
      ...
      <div className="mx-auto grid max-w-[var(--editable-container)] gap-10 px-4 py-12 sm:px-6 lg:grid-cols-[1.2fr_1fr_1fr] lg:px-8">
        <div>
          <Link href="/" className="inline-flex items-center gap-3">
            <img src={axidraLogo.src} alt={SITE_CONFIG.name} className="h-[3.75rem] w-[3.75rem] object-contain" />
